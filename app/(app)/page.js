...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">      
      <header className="p-4 flex justify-between items-center fixed top-0 left-0 w-full z-10 bg-white/95 backdrop-blur supports-[backdrop-filter]:bg-white/75 dark:bg-gray-800/95 shadow-sm">        
